        ...
        <form name="form" id="form">
            <div class="form-group">
                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        <input type="text" class="form-control" id="familyName" v-model="reqParam.familyName" placeholder="姓">
                    </div>
                    <div class="col-4">
                        <input type="text" class="form-control" id="firstName" v-model="reqParam.firstName" placeholder="名">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="row justify-content-center">
                    <div class="col-4"> 
                        <input type="text" class="form-control" id="familyNameCap" v-model="reqParam.familyNameCap" placeholder="せい">
                    </div>
                    <div class="col-4">
                        <input type="text" class="form-control" id="firstNameCap" v-model="reqParam.firstNameCap" placeholder="めい">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        <input type="tel" name="year" id="bYear" v-model="reqParam.bYear" class="form-control" maxlength="4" placeholder="年">
                    </div>
                    <div class="col-3">
                        <input type="tel" name="month" id="bMonth" v-model="reqParam.bMonth" class="form-control" maxlength="2" placeholder="月">
                    </div>
                    <div class="col-3">
                        <input type="tel" name="day" id="bDay" v-model="reqParam.bDay" class="form-control" maxlength="2" placeholder="日">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <label for="bloodType" class="col-4 control-label">血液型</label>
                <select name="bloodType" id="bloodType" v-model="reqParam.bloodType" class="form-control col-4">
            ...
            <div class="form-group">
                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        <input type="text" class="form-control" name="region" id="region" v-model="reqParam.region" placeholder="都道府県">
                    </div>
                    <div class="col-7">
                        <input type="text" class="form-control" name="city" id="city" v-model="reqParam.city" placeholder="市区町村以下">
                    </div>
                </div>
            </div>
            <div class="form-group row">
...
export default {
    ...
    methods: {
        ...
        send: function () {
            ...
            if (!this.reqParam.familyName || !this.reqParam.firstName || !this.reqParam.bYear || !this.reqParam.bDay || !this.reqParam.bMonth || !this.reqParam.bloodType || !this.reqParam.job || !this.reqParam.zipcode || !this.reqParam.phoneNumber || !this.reqParam.startDate || !this.reqParam.endDate) {
                this.$swal("入力不備があります")
                return true
            }
